...
public class ShortestPathFromSourceToAllVerticesWithPathTrace extends AdjacencyList {
    Queue<int[]> edges;
    ...
    public void displayResult() {
        for (int i = 0; i < shortestDistances.length; i++) {
            System.out.print(i + " -> " + shortestDistances[i] + " Path: ");
            int j = i;
            while(prev[j] != -1) {
    ...
    public static void main(String args []) {
        new ShortestPathFromSourceToAllVerticesWithPathTrace().work();
    }
}
